...
@section('content')
    <div class="container">
        <div class="p-2">
            ...
            <div class="p-2">
                <h4 class="">
                    <span class="">Category Trash List</span>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>               
                        ...
                        <tr class="text-center">
                            ...
                            <td class="">
                                <form action="{{ route('parent.category.restore', $row->id) }}" class="" method="post" id="{{'restore-form-'.$row->id}}">
                                    @csrf
                                ...
                                <form action="{{ route('parent.category.force_delete', $row->id) }}" class="" method="post" id="{{'delete-form-'.$row->id}}">
                                    @csrf
                                    @method('delete')
