        ...
        <div class="p-2">
            ...
            <div class="p-2">   
                <h4 class="">
                    ...
                    <a href="{{route('blog.trash')}}" class="btn btn-danger">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>               
                        ...
                        <tr class="text-center">
                            ...
                            <td class="">
                                <a class="btn btn-info" href="{{ route('blog.show', $row->id) }}" title="View Details">
                                    <span class="fas fa-eye text-light"></span>
                                </a>
                                <a class="btn btn-warning" href="{{ route('blog.edit', $row->id) }}" title="Edit">
                                    <span class="fas fa-edit text-light"></span>
                                </a>
                                
                                <form action="{{ route('blog.destroy', $row->id) }}" class="form-inline" method="post" id="{{'delete-form-'.$row->id}}">
                                    @csrf
                                    @method('delete')
